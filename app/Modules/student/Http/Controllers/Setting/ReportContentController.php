...
class ReportContentController extends Controller
{
    public function leaveRequest()
    {
        ...
        return view(
            'student::settings.reports-forms.endorsement',
    ...
    public function dailyRequest()
    {
        ...
        $content = ReportContent::first();
        return view(
            'student::settings.reports-forms.daily-request',
            compact('title', 'content')
        );
    }
    ...
    public function proofEnrollmentRequest()
    {
        ...
        $content = ReportContent::first();
        return view(
            'student::settings.reports-forms.proof-enrollment',
            compact('title', 'content')
        );
    }
    ...
    public function parentRequest()
    {
        ...
        $content = ReportContent::first();
        return view(
            'student::settings.reports-forms.parent-request',
            compact('title', 'content')
        );
    }
    ...
    {
        $title = trans('student::local.statement_request_form');
        $content = ReportContent::first();
        return view(
            'student::settings.reports-forms.statement-request',
            compact('title', 'content')
        );
    }
    public function updateStatementRequests()
    {
        $reportContent = ReportContent::first();
        $reportContent->update(request()->only(['statement_request']));
        toast(trans('msg.updated_successfully'), 'success');
        return redirect()->route('statement-request.get');
    }
}
