...
class StudentController extends Controller
{
    ...
    public function update(StudentRequest $request, Student $student)
    {
        ...
        if (
            $student_type != $student->student_type || $request->division_id != $student->division_id
    ...
    public function advancedSearchPage()
    {
        ...
        return view(
            'student::advanced-search.search',
            compact(
                'nationalities',
                'title',
                'studyLangs',
    ...
    public function search()
    {
        ...
        if (isset($filter[0])) {
            $factor[0] = $filter[0] == 'Null' ? $attribute[0] . ' is ' . $filter[0] : $attribute[0] . ' = ' . $filter[0];
        }
        if (isset($filter[1])) {
            $factor[1] = $filter[1] == 'Null' ? $attribute[1] . ' is ' . $filter[1] : $attribute[1] . ' = ' . $filter[1];
        }
        if (isset($filter[2])) {
            $factor[2] = $filter[2] == 'Null' ? $attribute[2] . ' is ' . $filter[2] : $attribute[2] . ' = ' . $filter[2];
        }
        if (isset($filter[3])) {
            $factor[3] = $filter[3] == 'Null' ? $attribute[3] . ' is ' . $filter[3] : $attribute[3] . ' = ' . $filter[3];
        }
        if (isset($filter[4])) {
            $factor[4] = $filter[4] == 'Null' ? $attribute[4] . ' is ' . $filter[4] : $attribute[4] . ' = ' . $filter[4];
        }
        if (isset($filter[5])) {
            $factor[5] = $filter[5] == 'Null' ? $attribute[5] . ' is ' . $filter[5] : $attribute[5] . ' = ' . $filter[5];
        }
        if (isset($filter[6])) {
            $factor[6] = $filter[6] == 'Null' ? $attribute[6] . ' is ' . $filter[6] : $attribute[6] . ' = ' . $filter[6];
        }
        if (isset($filter[7])) {
            $factor[7] = $filter[7] == 'Null' ? $attribute[7] . ' is ' . $filter[7] : $attribute[7] . ' = ' . $filter[7];
        }
        if (isset($filter[8])) {
            $factor[8] = $filter[8] == 'Null' ? $attribute[8] . ' is ' . $filter[8] : $attribute[8] . ' = ' . $filter[8];
        }
        if (isset($filter[9])) {
            $factor[9] = $filter[9] == 'Null' ? $attribute[9] . ' is ' . $filter[9] : $attribute[9] . ' = ' . $filter[9];
        }
        if (isset($filter[10])) {
            $factor[10] = $filter[10] == 'Null' ? $attribute[10] . ' is ' . $filter[10] : $attribute[10] . ' = ' . $filter[10];
        }
        if (isset($filter[11])) {
            $factor[11] = $filter[11] == 'Null' ? $attribute[11] . ' is ' . $filter[11] : $attribute[11] . ' = ' . $filter[11];
        }
        ...
        return datatables($data)
            ...
            ->rawColumns([
                'check', 'father_name', 'studentImage', 'registration_status', 'religion', 'student_type',
    ...
    private function dataTable($data)
    {
        return datatables($data)
            ...
            ->rawColumns([
                'check', 'studentName', 'registration_status', 'grade', 'student_type',
