...
class CreateTableMedicals extends Migration
{
    ...
    public function up()
    {
        Schema::create('medicals', function (Blueprint $table) {
            ...
            $table->enum('food_sensitivity',['yes','no'])->default('no')->nullable();
            $table->enum('medicine_sensitivity',['yes','no'])->default('no')->nullable();
            $table->enum('other_sensitivity',['yes','no'])->default('no')->nullable();
            $table->enum('have_medicine',['yes','no'])->default('no')->nullable();
            $table->enum('vision_problem',['yes','no'])->default('no')->nullable();
            $table->enum('use_glasses',['yes','no'])->default('no')->nullable();
            $table->enum('hearing_problems',['yes','no'])->default('no')->nullable();
            $table->enum('speaking_problems',['yes','no'])->default('no')->nullable();
            $table->enum('chest_pain',['yes','no'])->default('no')->nullable();
            $table->enum('breath_problem',['yes','no'])->default('no')->nullable();
            $table->enum('asthma',['yes','no'])->default('no')->nullable();
            $table->enum('have_asthma_medicine',['yes','no'])->default('no')->nullable();
            $table->enum('heart_problem',['yes','no'])->default('no')->nullable();
            $table->enum('hypertension',['yes','no'])->default('no')->nullable();
            $table->enum('diabetic',['yes','no'])->default('no')->nullable();
            $table->enum('anemia',['yes','no'])->default('no')->nullable();
            $table->enum('cracking_blood',['yes','no'])->default('no')->nullable();
            $table->enum('coagulation',['yes','no'])->default('no')->nullable();
