...
<h4 style="{{session('lang') == 'ar' ?'direction: rtl;':'direction: ltr;'}}">{{ trans('student::local.report_title') }} : {{$report->report_title}}</h4>

<h4 style="{{session('lang') == 'ar' ?'direction: rtl;':'direction: ltr;'}}">{{ trans('student::local.student_name') }} :         
    @if (session('lang') == 'ar')
...
<h4 style="{{session('lang') == 'ar' ?'direction: rtl;':'direction: ltr;'}}"><u>{{ trans('student::local.siblings') }}</u></h4>
...
<p style="text-align: justify;{{session('lang') == 'ar' ?'direction: rtl;':'direction: ltr;'}}">{{$report->report}}</p>
