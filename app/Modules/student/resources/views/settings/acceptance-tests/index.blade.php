                    ...
                    <table id="dynamic-table" class="table data-table" >
                        <thead class="bg-info white">
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{trans('student::local.ar_test_name')}}</th>
                                <th>{{trans('student::local.en_test_name')}}</th>
    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')
            ...
            buttons: [
                ...
                // delete btn
                @include('layouts.backEnd.includes.datatables._deleteBtn',['route'=>'acceptance-tests.destroy'])

                // default btns
                @include('layouts.backEnd.includes.datatables._datatableBtn')
            ],
          ajax: "{{ route('acceptance-tests.index') }}",
          columns: [
              {data: 'check',               name: 'check', orderable: false, searchable: false},
              {data: 'DT_RowIndex',         name: 'DT_RowIndex', orderable: false, searchable: false},
              {data: 'ar_test_name',        name: 'ar_test_name'},
              {data: 'en_test_name',        name: 'en_test_name'},
