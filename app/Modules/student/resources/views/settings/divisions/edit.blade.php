                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control "
                                                value="{{ old('ar_division_name', $division->ar_division_name) }}"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control "
                                                value="{{ old('ar_school_name', $division->ar_school_name) }}"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control "
                                                value="{{ old('en_division_name', $division->en_division_name) }}"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control "
                                                value="{{ old('en_school_name', $division->en_school_name) }}"
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control "
                                                value="{{ old('total_students', $division->total_students) }}"
