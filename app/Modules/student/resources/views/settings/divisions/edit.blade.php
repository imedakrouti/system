    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('divisions.update',$division->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <input type="text" class="form-control " value="{{old('ar_division_name',$division->ar_division_name)}}" placeholder="{{ trans('student::local.ar_division_name') }}"
                      ...
                      <div class="col-md-12">
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <input type="text" class="form-control " value="{{old('en_division_name',$division->en_division_name)}}" placeholder="{{ trans('student::local.en_division_name') }}"
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <input type="text" class="form-control " value="{{old('ar_school_name',$division->ar_school_name)}}" 
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <input type="text" class="form-control " value="{{old('en_school_name',$division->en_school_name)}}" 
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <input type="number" min="0" class="form-control " value="{{old('total_students',$division->total_students)}}" 
                      ...
                      <div class="col-md-12">
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <input type="number" min="0" class="form-control " value="{{old('sort',$division->sort)}}" placeholder="{{ trans('student::local.sort') }}"
                                name="sort" required>
                                <span class="red">{{ trans('student::local.requried') }}</span>
                            </div>
                          </div>
