    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('steps.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          <label>{{ trans('student::local.ar_step') }}</label>
                          <input type="text" class="form-control " value="{{old('ar_step')}}" placeholder="{{ trans('student::local.ar_step') }}"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          <label>{{ trans('student::local.en_step') }}</label>
                          <input type="text" class="form-control " value="{{old('en_step')}}" placeholder="{{ trans('student::local.en_step') }}"
