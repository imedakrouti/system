                    ...
                    <table id="dynamic-table" class="table data-table" >
                        <thead class="bg-info white">
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{trans('student::local.ar_name_lang')}}</th>
                                <th>{{trans('student::local.en_name_lang')}}</th>
    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')
            ...
            buttons: [
                // new btn
                {
                    "text": "{{trans('student::local.new_language')}}",
                ...
                // delete btn
                @include('layouts.backEnd.includes.datatables._deleteBtn',['route'=>'languages.destroy'])
          ...
          columns: [
              ...
              {data: 'ar_name_lang',        name: 'ar_name_lang'},
              {data: 'en_name_lang',        name: 'en_name_lang'},
