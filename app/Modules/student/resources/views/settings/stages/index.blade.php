                    ...
                    <table id="dynamic-table" class="table data-table" >
                        <thead class="bg-info white">
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{trans('student::local.ar_stage_name')}}</th>
                                <th>{{trans('student::local.en_stage_name')}}</th>                                
    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')
            ...
            buttons: [
                // new btn
                {
                    "text": "{{trans('student::local.new_stage')}}",
                ...
                // delete btn
                @include('layouts.backEnd.includes.datatables._deleteBtn',['route'=>'stages.destroy'])
          ...
          columns: [
              ...
              {data: 'ar_stage_name',       name: 'ar_stage_name'},
              {data: 'en_stage_name',       name: 'en_stage_name'},
              {data: 'sort',                name: 'sort'},               
