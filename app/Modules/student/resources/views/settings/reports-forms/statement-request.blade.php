        ...
        <div class="card-body">
          ...
          <div class="row">
              ...
              <div class="col-lg-8 col-md-12"> 
                <form class="form form-horizontal" action="{{route('statement-request.update')}}" method="post">
                    @csrf                    
                    <textarea class="form-control" name="statement_request" id="ckeditor" cols="30" rows="10" class="ckeditor">{{old('statement_request',$content->statement_request)}}</textarea>                          
