                    ...
                    <div class="card-body">
                        ...
                        <div class="row">                        
                            <div class="col-lg-12 col-md-12">
                                <form class="form form-horizontal" action="{{ route('parent-request.update') }}"
                                    method="post">
                                    @csrf
                                    <textarea class="form-control" name="parent_request" id="ckeditor" cols="30" rows="10"
                                        class="ckeditor">{{ old('parent_request', $content->parent_request) }}</textarea>
                ...
                pluginsLoaded: function() {
                    ...
                    editor.ui.addRichCombo( 'myCombo', {
                        ...
                        init: function() {
                            ...
                            ' [[Division]] ',' [[Grade]] ',' [[Academic Year]] ',' [[School name]] ',' [[Date]] ',' [[Notes]] ',' [[Date request]] ',' [[Attend time]] ' ];
