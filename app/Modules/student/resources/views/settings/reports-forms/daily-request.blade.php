        ...
        <div class="card-body">
          ...
          <div class="row">        
            <div class="col-lg-12 col-md-12"> 
                <form class="form form-horizontal" action="{{route('daily-request.update')}}" method="post">
                    @csrf                    
                    <textarea class="form-control" name="daily_request" id="ckeditor" cols="30" rows="10" class="ckeditor">{{old('daily_request',$content->daily_request)}}</textarea>                          
                ...
                pluginsLoaded: function() {
                    ...
                    editor.ui.addRichCombo( 'myCombo', {
                        ...
                        init: function() {
                            ...
                            ' [[القسم الاكاديمي]] ',' [[الصف الدراسي]] ',' [[العام الدراسي]] ',' [[اسم المدرسة]] ',' [[التاريخ]] ' ,' [[وقت الانصراف]] ',' [[اسم المستلم]] '];
                            var en_items = [ ' [[Nationality]] ', ' [[Student name]] ' ,' [[Student national id number]] ',' [[Religion]] ',' [[Date of birth]] ',
                            ' [[Division]] ',' [[Grade]] ',' [[Academic Year]] ',' [[School name]] ',' [[Date]] ',' [[Leave time]] ',' [[The recipients name]] ' ];
