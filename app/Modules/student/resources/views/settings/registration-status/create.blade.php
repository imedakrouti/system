    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('registration-status.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{old('ar_name_status')}}" placeholder="{{ trans('student::local.ar_name_status') }}"
                              name="ar_name_status">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{old('en_name_status')}}" placeholder="{{ trans('student::local.en_name_status') }}"
                              name="en_name_status">
                          </div>
                        </div>
                    </div>                    
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <select name="shown" class="form-control">
                                <option {{old('shown') == trans('student::local.show_regg')?'selected':''}} value="show">{{ trans('student::local.show_regg') }}</option>
                                <option {{old('shown') == trans('student::local.hidden_reg')?'selected':''}} value="hidden">{{ trans('student::local.hidden_reg') }}</option>                                
                            </select>
                          </div>
                        </div>
                    </div>                     
