                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="date" class="form-control " value="{{ old('start_from') }}"
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('student::local.end_from') }}</label>
                                              <input type="date" class="form-control " value="{{ old('end_from') }}"
                                      ...
                                      <div class="form-group">
                                          <label>{{ trans('student::local.default_year') }}</label>
                                            <select name="status" class="form-control">
                                                <option
                                                    {{ old('status') == trans('student::local.not_current') ? 'selected' : '' }}
                                                    value="not current">{{ trans('student::local.not_current') }}</option>
                                                <option
                                                    {{ old('status') == trans('student::local.current') ? 'selected' : '' }}
                                        ...
                                        <div class="form-group">
                                          <label>{{ trans('student::local.year_status') }}</label>
                                            <select name="year_status" class="form-control">
                                                <option
                                                    {{ old('year_status') == trans('student::local.close') ? 'selected' : '' }}
                                                    value="close">{{ trans('student::local.no') }}</option>
                                                <option
                                                    {{ old('year_status') == trans('student::local.open') ? 'selected' : '' }}
