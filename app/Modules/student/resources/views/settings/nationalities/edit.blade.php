      ...
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('nationalities.index')}}">{{ trans('student::local.registration_status') }}</a></li>
                ...
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{old('ar_name_nationality',$nationality->ar_name_nationality)}}" placeholder="{{ trans('student::local.ar_name_nationality') }}"
