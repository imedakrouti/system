                ...
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('ar_document_name',$admissionDoc->ar_document_name)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('en_document_name',$admissionDoc->en_document_name)}}" 
