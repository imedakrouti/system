                ...
                <div class="col-md-12">                
                    ...
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="active1" aria-labelledby="active-tab1"
                            ...
                            <div class="row">            
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        <select name="mother_id" class="form-control " readonly>                
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">                    
                                        <select name="student_id_type" class="form-control" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        name="student_id_number" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        <select name="nationality_id" class="form-control " readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="native_lang_id" class="form-control "  readonly>
                                                <option value="">{{ trans('student::local.select') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="second_lang_id" class="form-control "  readonly>
                                                <option value="">{{ trans('student::local.select') }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">                    
                                        <select name="son_employee" class="form-control" readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                                        </select>
                                      </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-9">                    
                                        <select name="guardian_id" class="form-control" readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                        ...
                        <div class="tab-pane" id="active2" role="tabpanel" aria-labelledby="link-tab1" aria-expanded="false">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">                    
                                            <select name="student_type" class="form-control"  readonly>
                                                <option value="">{{ trans('student::local.select') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">                    
                                            <select name="reg_type" class="form-control"  readonly>
                                                <option value="">{{ trans('student::local.select') }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        <select name="registration_status_id" class="form-control "  readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        <select name="division_id" class="form-control "  readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-9">
                                        <select name="grade_id" class="form-control "  readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                        ...
                        <div class="tab-pane" id="active4" role="tabpanel" aria-labelledby="dropdownOpt2-tab1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-8">                    
                                        <select name="employee_id" class="form-control" readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <ul style="list-style: none" id="stepId" readonly>
                          ...
                          <div class="alert alert-light">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        <select name="school_id" class="form-control" readonly>
                                            <option value="">{{ trans('student::local.select') }}</option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">                                    
                                        <textarea name="transfer_reason" class="form-control" cols="30" readonly rows="5">{{old('transfer_reason',$student->transfer_reason)}}</textarea>
                                    </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="active7" role="tabpanel" aria-labelledby="dropdownOpt2-tab1"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-9">
                                    ...
                                    name="submitted_id_number" readonly>                
                                </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                ...
                                <div class="col-md-9">
                                    ...
                                    name="submitted_mobile" readonly>                
                                </div>
                                </div>
                            </div>
                        </div> 
                                    ...
                                    @if (count($student->addresses) > 0)
                                        @foreach ($student->addresses as $address)
                                            <div class="input-group mb-1" data-repeater-item>
                                                ...
                                                class="form-control" id="example-tel-input" value="{{$address->full_address}}" readonly>
