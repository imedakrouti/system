    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
              <div class="col-md-12">
                  <h2 class="mb-2">{{$fatherName}}</h2>
              </div>
            <div class="col-md-12">
                <a href="#" class="btn btn-success white"><i class="la la-graduation-cap"></i> {{ trans('student::local.add_son') }}</a>
                <a href="{{route('fathers.addWife',$id)}}" class="btn btn-success white"><i class="la la-female"></i> {{ trans('student::local.add_mother') }}</a>
                <a href="#" class="btn btn-primary white"><i class="la la-eye"></i> {{ trans('student::local.show_father_data') }}</a>
