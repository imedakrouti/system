<form action="#" method="get" id="filterForm" target="_blank">
    <div class="row mt-1">
        <div class="col-lg-2 col-md-5 mb-md-1">
            <select name="year_id" class="form-control select2" style="width: 100%" id="filter_year_id" required>                
        ...
        <div class="col-lg-2 col-md-5 mb-md-1">
            <select name="division_id[]" class="form-control select2" style="width: 100%" multiple id="filter_division_id" required>
        ...
        <div class="col-lg-2 col-md-5 mb-md-1">
            <select name="grade_id" class="form-control select2" style="width: 100%" id="filter_grade_id">                
        ...
        <div class="col-lg-2 col-md-5 mb-md-1">
            <select name="status_id" class="form-control select2" style="width: 100%" id="filter_status_id">
