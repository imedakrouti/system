    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('parent-requests.update',$parentRequest->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
...
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-content collapse show">
        <div class="card-body">
            <h5><strong>{{ trans('student::local.created_by') }} :</strong> {{$parentRequest->admin->name}}</h5>
            <h5><strong>{{ trans('student::local.created_at') }} :</strong> {{$parentRequest->created_at}}</h5>
            <h5><strong>{{ trans('student::local.updated_at') }} :</strong> {{$parentRequest->updated_at}}</h5>
        </div>
      </div>
    </div>
  </div>
