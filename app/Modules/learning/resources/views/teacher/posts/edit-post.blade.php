...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 mb-1">
            ...
            <h1 class="top-left">
                <strong>{{ session('lang') == 'ar' ? $post->classroom->ar_name_classroom : $post->classroom->en_name_classroom }}</strong>
            </h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{ route('posts.update', $post->id) }}"
                            ...
                            <div class="form-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea required name="post_text" class="form-control" cols="30" rows="10"
                                            id="ckeditor"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control" name="youtube_url" id="url"
                                            value="{{ old('url', $post->youtube_url) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <button type="button"
                                        onclick="location.href='{{ route('posts.index', $post->classroom_id) }}';"
