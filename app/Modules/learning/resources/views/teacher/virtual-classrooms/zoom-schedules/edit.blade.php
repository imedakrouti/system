  ...
  <div class="col-12">
    <div class="card">
      <div class="card-content collapse show">
        <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('zoom-schedules.update',$zoomSchedule->id)}}">
              @csrf
              @method('PUT')
              <div class="form-body">
                  ...
                  <div class="row">  
                      <div class="col-lg-9 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="topic" value="{{old('topic',$zoomSchedule->topic)}}" 
                            ...
                            <div class="form-group">
                              ...
                              <select name="subject_id" class="form-control" required>                                
                                  @foreach (employeeSubjects() as $subject)
                                      <option {{old('subject_id',$zoomSchedule->subject_id) == $subject->id ? 'selected' : ''}} value="{{$subject->id}}">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date"  class="form-control " value="{{old('start_date',$zoomSchedule->start_date)}}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control " value="{{old('start_time',$zoomSchedule->start_time)}}"
                            ...
                            <div class="form-group"> 
                                ...
                                <select name="classroom_id" class="form-control" id="filter_room_id" required>
                                    ...
                                    @foreach (employeeClassrooms() as $classroom)
                                        <option {{old('classroom_id',$zoomSchedule->classroom_id)==$classroom->id ? 'selected':''}} value="{{$classroom->id}}">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group row">
                            ...
                            <textarea name="notes" class="form-control" cols="30" rows="5">{{old('notes',$zoomSchedule->notes)}}</textarea>                        
                        </div>
                    </div>                                                           
              </div>
