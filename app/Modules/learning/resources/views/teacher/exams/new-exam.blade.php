                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a
                                href="{{ route('teacher.view-exams') }}">{{ trans('learning::local.exams') }}</a>
                        </li>
                        ...
                        <form class="form form-horizontal" method="POST" action="{{ route('teacher.store-exam') }}">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="divisions[]" class="form-control select2" id="filter_division_id"
                                                required multiple>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="grades[]" class="form-control select2" id="filter_grade_id"
                                                required multiple>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="exam_type" class="form-control">
                                                <option value="quiz">{{trans('learning::local.quiz')}}</option>
                                                <option value="exam">{{trans('learning::local.exam')}}</option>
                                            </select>
                                        </div>
                                    </div>                                    
                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control "
                                                value="{{ old('total_mark') }}" name="total_mark" required>
                                            <span class="red">{{ trans('learning::local.required') }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control "
                                                value="{{ old('no_question_per_page') }}" name="no_question_per_page"
                                                required>
                                            <span class="red">{{ trans('learning::local.required') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="auto_correct" class="form-control">
                                                <option {{ old('auto_correct') == 'no' ? 'selected' : '' }} value="no">
                                                    {{ trans('learning::local.no') }}</option>
                                                <option {{ old('auto_correct') == 'yes' ? 'selected' : '' }} value="yes">
                                                    {{ trans('learning::local.yes') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="show_results" class="form-control">
                                                <option {{ old('show_results') == 'no' ? 'selected' : '' }} value="no">
                                                    {{ trans('learning::local.no') }}</option>
                                                <option {{ old('show_results') == 'yes' ? 'selected' : '' }} value="yes">
                                                    {{ trans('learning::local.yes') }}</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions left">
                                ...
                                <button type="button" class="btn btn-warning mr-1"
                                    onclick="location.href='{{ route('teacher.view-exams') }}';">
