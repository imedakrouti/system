<div class="form-group">     
    <!-- Modal -->
    <div class="modal fade text-left" id="complete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
    aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel18"><i class="la la-share"></i> {{ trans('learning::local.question_complete') }}</h4>
          ...
          <div class="modal-body">  
            ...
            <form  action="{{route('homework.store-question')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-4">                    
                    <input type="hidden" name="homework_id" id="complete_homework_id" value="">                    
                    <input type="hidden" name="question_type" value="complete">                    
                </div>
                <div class="row">
                ...
                <div class="form-group col-12 contact-repeater">
                    <div data-repeater-list="repeater-group">
                        ...
                        <input type="text" name="answer_text" required  class="form-control" placeholder="{{ trans('learning::local.possible_answers') }}" id="example-tel-input">                        
