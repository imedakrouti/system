      ...
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('exams.show',$question->exam->id)}}">{{ $question->exam->exam_name}}</a></li>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('questions.update',$question->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    <h4 class="form-section"> {{ $title }} | {{$question->question_type}}</h4>
                ...
                <div class="form-actions left">
                    ...
                    <button type="button" class="btn btn-warning mr-1" onclick="location.href='{{route('exams.show',$question->exam_id)}}';">
