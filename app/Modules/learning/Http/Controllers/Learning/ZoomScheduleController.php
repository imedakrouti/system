...
class ZoomScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-schedules.index',
            compact('title')
        );
    }
    ...
    private function dataTable($data)
    {
        return datatables($data)
            ...
            ->addColumn('start_class', function ($data) {
                ...
                // today
                if (
                    $data->start_date <= date_format(\Carbon\Carbon::now(), "Y-m-d") &&
    ...
    public function viewZoomSchedule()
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-schedules.view-schedule',
    ...
    private function color($date, $time)
    {
        ...
        // today
        if (
            $date <= date_format(\Carbon\Carbon::now(), "Y-m-d") &&
            date_format($time->subMinutes(1), "H:i") < date_format(\Carbon\Carbon::now(), "H:i")
        ) {
            $color = 'green';
        }
    ...
    public function zoomLive($zoom_schedule_id)
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-live',
            compact('title')
        );
    }
    ...
    public function create()
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-schedules.create',
            compact('title')
        );
    }
    ...
    public function edit(ZoomSchedule $zoomSchedule)
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-schedules.edit',
    ...
    public function attendances($zoom_schedule_id)
    {
        ...
        return view(
            'learning::teacher.virtual-classrooms.zoom-schedules.attendances',
