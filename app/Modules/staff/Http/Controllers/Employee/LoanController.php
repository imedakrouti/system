...
class LoanController extends Controller
{
    ...
    public function cancel()
    {
        if (request()->ajax()) {
            foreach (request('id') as $id) {
                Loan::where('id', $id)->where('approval1', 'Pending')->orWhere('approval2', 'Pending')
        ...
        if (request()->ajax()) {
            ...
            return datatables($data)
                ...
                ->addColumn('updated_at', function ($data) {
                    if ($data->approval1 != trans('learning::local.pending')) {
                ...
                ->rawColumns(['approval1', 'approval2', 'updated_at', 'check'])
                ->make(true);
        }
