            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('vacations.index') }}">{{ trans('staff::local.vacations') }}</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{ route('vacations.store') }}"
                            ...
                            <div class="form-actions left">
                                ...
                                <button type="button" class="btn btn-warning mr-1"
                                    onclick="location.href='{{ route('vacations.index') }}';">
