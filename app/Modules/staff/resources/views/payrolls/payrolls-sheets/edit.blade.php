    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('payrolls-sheets.update',$payroll_sheet_id->id)}}">
                @csrf                
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control " value="{{old('ar_sheet_name',$payroll_sheet_id->ar_sheet_name)}}" 
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control " value="{{old('en_sheet_name',$payroll_sheet_id->en_sheet_name)}}" 
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                              ...
                              <select name="end_period" class="form-control" required>
                                  <option {{old('end_period',$payroll_sheet_id->end_period) =='End Month' ? 'selected':'' }} value="End Month">{{ trans('staff::local.this_month') }}</option>
                                  <option {{old('end_period',$payroll_sheet_id->end_period) =='Next Month' ? 'selected':'' }} value="Next Month">{{ trans('staff::local.next_month') }}</option>
                              </select>
                                <span class="red">{{ trans('staff::local.required') }}</span>                          
                            </div>
                        </div>              
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('from_day',$payroll_sheet_id->from_day)}}" 
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control " value="{{old('to_day',$payroll_sheet_id->to_day)}}" 
