      ...
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('leave-permissions.index')}}">{{ trans('staff::local.leave_permissions') }}</a></li>
          ...
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('leave-permissions.store')}}">
                        ...
                        <div class="form-group row">
                          ...
                          <select name="leave_type_id" id="leave_type_id" class="form-control" required>
                              ...
                              @foreach ($leave_types as $leave_type)
                                  <option {{old('leave_type_id') == $leave_type->id ? 'selected' :''}} value="{{$leave_type->id}}">
                ...
                <div class="form-actions left">
                    ...
                    <button type="button" class="btn btn-warning mr-1" onclick="location.href='{{route('leave-permissions.index')}}';">
