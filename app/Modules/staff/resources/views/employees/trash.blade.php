    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')            
            buttons: [
                // new btn
                {
                    "text": "{{trans('staff::local.restore')}}",
                    ...
                    action : function ( e, dt, node, config ) {
                        ...
                        swal({
                            title: "{{trans('staff::local.restore')}}",
                            text: "{{trans('staff::local.restore_employee_confirm')}}",
                            ...
                            function() {
                                ...
                                .done(function(data) {
                                    swal("{{trans('staff::local.restore')}}", "{{trans('msg.restored_successfully')}}", "success");
                                })
                            }
                        );
                        // end swal
