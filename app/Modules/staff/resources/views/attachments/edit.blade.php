    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('attachments.update',$attachment->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <select name="employee_id" id="employee_id" class="form-control select2" required>
                              ...
                              @foreach ($employees as $employee)
                                  <option {{old('employee_id',$attachment->employee_id) == $employee->id ? 'selected' :''}} value="{{$employee->id}}">
                                  @if (session('lang') == 'ar')
