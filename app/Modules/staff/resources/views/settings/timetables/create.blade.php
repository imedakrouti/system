    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('timetables.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('ar_timetable')}}" 
                      ...
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="{{old('en_timetable')}}" 
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="time" class="form-control " value="{{old('on_duty_time')}}"                             
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control " value="{{old('off_duty_time')}}"                             
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="time" class="form-control " value="{{old('beginning_in')}}"                             
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control " value="{{old('ending_in')}}"                             
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="time" class="form-control " value="{{old('beginning_out')}}"                             
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control " value="{{old('ending_out')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.saturday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('saturday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.sunday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('sunday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.monday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('monday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.tuesday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('tuesday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.wednesday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('wednesday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.thursday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('thursday_value')}}"                             
                      ...
                      <div class="col-lg-1 col-md-3">
                        <div class="form-group">
                          <label>{{ trans('staff::local.friday') }}</label>
                              <input type="number" min="0" class="form-control " value="{{old('friday_value')}}"                             
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control " value="{{old('daily_late_minutes')}}"                             
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" min="0" step="0.25" class="form-control " value="{{old('day_absent_value')}}"                             
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control " value="{{old('no_attend')}}"                             
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" min="0" step="0.25" class="form-control " value="{{old('no_leave')}}"                             
                    ...
                    <div class="col-lg-3 col-md-6">
                      <div class="form-group row">
                        ...
                        <input type="number" min="0" step="0.25" class="form-control " value="{{old('check_in_before_leave')}}"                             
