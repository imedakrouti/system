    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('holidays.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('ar_holiday')}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('en_holiday')}}" 
