    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('external-codes.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('pattern')}}" 
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="replacement"class="form-control" required cols="30" rows="5">{{old('replacement')}}</textarea>
                            <span class="red">{{ trans('staff::local.required') }}</span>                          
                        </div>
                    </div>
