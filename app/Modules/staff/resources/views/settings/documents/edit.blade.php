    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('documents.update',$document->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('ar_document',$document->ar_document)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('en_document',$document->en_document)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" min="0" class="form-control " value="{{old('sort',$document->sort)}}" 
