    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('departments.update',$department->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <select name="sector_id" class="form-control" required>
                                ...
                                @foreach ($sectors as $sector)
                                    <option {{old('sector_id',$department->sector_id) == $sector->id ? 'selected' : ''}} value="{{$sector->id}}">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('ar_department',$department->ar_department)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('en_department',$department->en_department)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" min="0" class="form-control " value="{{old('leave_allocate',$department->leave_allocate)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" min="0" class="form-control " value="{{old('sort',$department->sort)}}" 
