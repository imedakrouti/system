                    ...
                    <table id="dynamic-table" class="table data-table" >
                        <thead class="bg-info white">
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{trans('staff::local.ar_department')}}</th>
                                <th>{{trans('staff::local.en_department')}}</th>
                                <th>{{trans('staff::local.sector_id')}}</th>
                                <th>{{trans('staff::local.leave_allocate')}}</th>
    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')            
            buttons: [
                // new btn
                {
                    "text": "{{trans('staff::local.new_department')}}",
          ...
          columns: [
              ...
              {data: 'ar_department',       name: 'ar_department'},
              {data: 'en_department',       name: 'en_department'},
              {data: 'sector_id',           name: 'sector_id'},
              {data: 'leave_allocate',      name: 'leave_allocate'},
              {data: 'sort',                name: 'sort'},               
