                    ...
                    <table id="dynamic-table" class="table data-table" >
                        <thead class="bg-info white">
                            <tr>
                                ...
                                <th>#</th>
                                <th>{{trans('staff::local.ar_position')}}</th>
                                <th>{{trans('staff::local.en_position')}}</th>
    ...
    $(function () {
        ...
        @include('layouts.backEnd.includes.datatables._datatableConfig')            
            buttons: [
                // new btn
                {
                    "text": "{{trans('staff::local.new_position')}}",
                ...
                // delete btn
                @include('layouts.backEnd.includes.datatables._deleteBtn',['route'=>'positions.destroy'])
          ...
          columns: [
              ...
              {data: 'ar_position',           name: 'ar_position'},
              {data: 'en_position',           name: 'en_position'},
              {data: 'sort',                name: 'sort'},               
