    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('machines.update',$machine->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('device_name',$machine->device_name)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " value="{{old('ip_address',$machine->ip_address)}}" 
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" min="0" class="form-control " value="{{old('port',$machine->port)}}" 
