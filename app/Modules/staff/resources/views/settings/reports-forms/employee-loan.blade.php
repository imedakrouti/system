        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-12"> 
                <form class="form form-horizontal" action="{{route('employee-loan.update')}}" method="post">
                    @csrf                    
                    <textarea class="form-control" name="employee_loan" id="ckeditor" cols="30" rows="10" class="ckeditor">{{old('employee_loan',$content->employee_loan)}}</textarea>                          
