        ...
        <div class="card-body">
          ...
          <div class="row">        
            <div class="col-lg-12 col-md-12"> 
                <form class="form form-horizontal" action="{{route('header.update')}}" method="post">
                    @csrf                    
                    <textarea class="form-control" name="header" id="ckeditor" cols="30" rows="10" class="ckeditor">{{old('header',$content->header)}}</textarea>                          
