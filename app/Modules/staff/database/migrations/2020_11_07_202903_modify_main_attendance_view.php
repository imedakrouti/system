...
class ModifyMainAttendanceView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::connection('mysql')->statement(
            "CREATE OR REPLACE VIEW main_attendance_sheet
             AS
             SELECT            
            final_attendance_sheet.*,request_leave_types.target,
            ...
            OR (
               ...
               ,IF((DAYNAME(`final_attendance_sheet`.`selected_date`) = 'Saturday' || DAYNAME(`final_attendance_sheet`.`selected_date`) = 'Friday') &&  (
                     vacation_period_view.vacation_type != 'Regular vacation' 
                     OR vacation_period_view.vacation_type != 'Work errand'
                     OR vacation_period_view.vacation_type != 'Training'
                    )
