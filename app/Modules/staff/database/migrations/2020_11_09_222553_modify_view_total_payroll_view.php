...
class ModifyViewTotalPayrollView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::connection('mysql')->statement(
            ...
            DATE(payroll_components.created_at) as created_at
            ...
            payroll_components.from_date,payroll_components.to_date,payroll_components.total_employees,
            admins.username,payroll_sheets.id,created_at
            "
          );
