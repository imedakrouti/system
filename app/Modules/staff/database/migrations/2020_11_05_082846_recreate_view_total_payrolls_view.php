...
class RecreateViewTotalPayrollsView extends Migration
{
    ...
    public function up()
    {
        DB::connection('mysql')->statement(
            ...
            payroll_components.total_employees,ar_sheet_name,en_sheet_name,admins.username
            ...
            payroll_components.from_date,payroll_components.to_date,payroll_components.total_employees,admins.username
            "
          );
