    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('departments.update',$department->id)}}"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$department->ar_department_name}}" placeholder="{{ trans('admin.ar_department_name') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$department->en_department_name}}" placeholder="{{ trans('admin.en_department_name') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                              <textarea name="description" class="form-control "  cols="30" rows="5">{{$department->description}}</textarea>
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$department->keywords}}" placeholder="{{ trans('admin.keywords') }}"
                              name="keywords" ">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <select name="show" class="form-control">
                                ...
                                <option {{ ($department->show == trans('admin.yes'))?'selected':''}} value="yes">{{ trans('admin.yes') }}</option>
                                <option {{ ($department->show == trans('admin.no'))?'selected':''}} value="no">{{ trans('admin.no') }}</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="number" min="0" class="form-control " value="{{$department->sort}}" placeholder="{{ trans('admin.sort') }}"
                              name="sort" ">
                          </div>
                        </div>
                    </div>
...
<script>
	    ...
	    {
			 var category_id = "{{ $department->category_id }}";
	        $.ajax({
				type:'POST',
