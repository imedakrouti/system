    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('cities.update',$city->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$city->ar_city_name}}" placeholder="{{ trans('admin.ar_city_name') }}"
                              name="ar_city_name" ">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$city->en_city_name}}" placeholder="{{ trans('admin.en_city_name') }}"
                              name="en_city_name" ">
                          </div>
                        </div>
                    </div>
...
<script>
	    ...
	    {
			 var country_id = "{{ $city->country_id }}";
	        $.ajax({
				type:'POST',
