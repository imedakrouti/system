    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item {{request()->segment(2)=='settings'?'active':''}}"><a href="#"><i class="la la-gears"></i><span class="menu-title" data-i18n="nav.dash.main">{{ trans('admin.settings') }}</span></a>
            <ul class="menu-content">
                <li class="{{request()->segment(3)=='years'?'active':''}}"><a class="menu-item" href="{{route('years.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.academic_years') }}</a></li>           
                <li class="{{request()->segment(3)=='divisions'?'active':''}}"><a class="menu-item" href="{{route('divisions.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.divisions') }}</a></li>           
                <li class="{{request()->segment(3)=='stages'?'active':''}}"><a class="menu-item" href="{{route('stages.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.stages') }}</a></li>           
                <li class="{{request()->segment(3)=='grades'?'active':''}}"><a class="menu-item" href="{{route('grades.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.grades') }}</a></li>           
                <li class="{{request()->segment(3)=='admission-documents'?'active':''}}"><a class="menu-item" href="{{route('admission-documents.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.admission_documents') }}</a></li>           
                <li class="{{request()->segment(3)=='documents-grades'?'active':''}}"><a class="menu-item" href="{{route('documents-grades.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.grade_documents') }}</a></li>           
                <li class="{{request()->segment(3)=='steps'?'active':''}}"><a class="menu-item" href="{{route('steps.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.admission_steps') }}</a></li>           
                <li class="{{request()->segment(3)=='acceptance-tests'?'active':''}}"><a class="menu-item" href="{{route('acceptance-tests.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.acceptance_tests') }}</a></li>           
                <li class="{{request()->segment(3)=='registration-status'?'active':''}}"><a class="menu-item" href="{{route('registration-status.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.registration_status') }}</a></li>           
                <li class="{{request()->segment(3)=='nationalities'?'active':''}}"><a class="menu-item" href="{{route('nationalities.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.nationalities') }}</a></li>           
                <li class="{{request()->segment(3)=='interviews'?'active':''}}"><a class="menu-item" href="{{route('interviews.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.interviews') }}</a></li>           
                <li class="{{request()->segment(3)=='languages'?'active':''}}"><a class="menu-item" href="{{route('languages.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.languages') }}</a></li>           
                <li class="{{request()->segment(3)=='classrooms'?'active':''}}"><a class="menu-item" href="{{route('classrooms.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.classrooms') }}</a></li>           
                <li class="{{request()->segment(3)=='id-designs'?'active':''}}"><a class="menu-item" href="{{route('id-designs.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.id_designs') }}</a></li>           
                <li class="{{request()->segment(3)=='schools'?'active':''}}"><a class="menu-item" href="{{route('schools.index')}}" data-i18n="nav.dash.ecommerce"><i class="la la-angle-left"></i> {{ trans('admin.schools_names') }}</a></li>           
            </ul>
        </li>                                              
      </ul>
    </div>
