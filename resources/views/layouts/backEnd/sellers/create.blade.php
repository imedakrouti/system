    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('sellers.store')}}">
                @csrf
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{old('seller_name')}}" placeholder="{{ trans('admin.seller_name') }}"
                              name="seller_name">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="number" min="0" class="form-control " value="{{old('mobile')}}" placeholder="{{ trans('admin.mobile') }}"
                              name="mobile">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{old('email')}}" placeholder="{{ trans('admin.email') }}"
                              name="email">
                          </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <select name="activition" class="form-control">
                                ...
                                <option {{ (old('activition') == 'active')?'selected':''}} value="active">{{ trans('admin.active') }}</option>
                                <option {{ (old('activition') == 'not_active')?'selected':''}} value="not active">{{ trans('admin.not_active') }}</option>
                            </select>
                          </div>
                        </div>
                      </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="pac-input" class="form-control " value="{{old('address')}}" placeholder="{{ trans('admin.address') }}"
                              name="address" ">
                          </div>
                        </div>
                    </div>
