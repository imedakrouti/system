    ...
    <div class="col-12">
      <div class="card">
        <div class="card-content collapse show">
          <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('offers.update',$offer->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$offer->title}}" placeholder="{{ trans('admin.title') }}"
                              name="title" ">
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                              <input type="datetime-local"  class="form-control" name="start_display" value="{{$offer->start_display}}">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                              <input type="datetime-local" class="form-control" name="end_display" value="{{$offer->end_display}}">
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <select name="status_display" class="form-control">
                                ...
                                <option {{ ($offer->status_display == 'yes')?'selected':''}} value="yes">{{ trans('admin.yes') }}</option>
                                <option {{ ($offer->status_display == 'no')?'selected':''}} value="no">{{ trans('admin.no') }}</option>
                            </select>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <select name="start_offer" class="form-control">
                                <option>{{ trans('admin.select') }}</option>
                                <option {{ ($offer->start_offer == 'active')?'selected':''}} value="active">{{ trans('admin.yes') }}</option>
                                <option {{ ($offer->start_offer  == '')?'selected':''}} value="">{{ trans('admin.no') }}</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control " value="{{$offer->link}}" placeholder="{{ trans('admin.link') }}"
                              name="link" ">
                          </div>
                        </div>
                    </div>
