            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">{{ trans('admin.hello') }},
                    {{session('lang') == 'ar'? userAuthInfo()->ar_name : userAuthInfo()->name}}  
                </span>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item" href="{{route('user.logout')}}"><i class="ft-power"></i> {{ trans('admin.logout') }}</a>
              </div>
            </li>
