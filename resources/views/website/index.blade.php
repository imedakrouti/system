...
<head>
    ...
    <!-- Website Title -->
    <title>Smart School Solutions</title>
	...
	<!-- Favicon  -->
    <link rel="icon" href="{{asset('website/images/favicon.png')}}">
</head>
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="{{route('login')}}"><span class="item-text">Student Demo</span></a>
                    </div>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">School ERB  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </span> Smart School Solutions </h1>
                            {{-- <h1><span class="turquoise">StartUp Landing</span> Page Template Free</h1> --}}
                            <p class="p-large">Powerful school management software comes with an incredible set of customizable features to assist with your school administration tasks and complex processes.</p>
                            <a class="btn-solid-lg page-scroll" href="#services">DISCOVER</a>
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="{{asset('website/images/header-teamwork.svg')}}" alt="alternative">
    ...
    <div class="basic-1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="{{asset('website/images/details-1-office-worker.svg')}}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="{{asset('website/images/details-2-office-team-work.svg')}}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
	...
	<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="{{asset('website/images/details-lightbox-1.svg')}}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
	...
	<div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="{{asset('website/images/details-lightbox-2.svg')}}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="{{asset('website/images/video-frame.svg')}}" alt="alternative">
    ...
    <div class="slider-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="{{asset('website/images/testimonials-2-men-talking.svg')}}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <h2>Testimonials</h2>
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{asset('website/images/testimonial-1.svg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{asset('website/images/testimonial-2.svg')}}" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="{{asset('website/images/testimonial-3.svg')}}" alt="alternative">
                                        <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('website/images/team-member-1.svg')}}" alt="alternative">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('website/images/team-member-2.svg')}}" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('website/images/team-member-3.svg')}}" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="{{asset('website/images/team-member-4.svg')}}" alt="alternative">
                        </div> <!-- end of image wrapper -->
    ...
    <!-- Scripts -->
    <script src="{{asset('website/js/jquery.min.js')}}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{asset('website/js/popper.min.js')}}"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="{{asset('website/js/bootstrap.min.js')}}"></script> <!-- Bootstrap framework -->
    <script src="{{asset('website/js/jquery.easing.min.js')}}"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="{{asset('website/js/swiper.min.js')}}"></script> <!-- Swiper for image and text sliders -->
    <script src="{{asset('website/js/jquery.magnific-popup.js')}}"></script> <!-- Magnific Popup for lightboxes -->
    <script src="{{asset('website/js/validator.min.js')}}"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="{{asset('website/js/scripts.js')}}"></script> <!-- Custom scripts -->
</body>
</html>